...
{
    public interface IIssueQuerySpecificationHandler
    {
        IEnumerable<Type> HandleSchemaTarget { get; }
        IQuerySpecification Union(IQuerySpecification[] querySpecifications);
        Task<decimal[]> SearchIssueAsync(JiraContext jiraContext, IQuerySpecification querySpecification, decimal[] sourceIssueIds = null, CancellationToken cancellationToken = default);
    }
}
