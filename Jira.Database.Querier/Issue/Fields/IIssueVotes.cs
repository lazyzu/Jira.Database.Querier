...
{
    public class IssueVotesProjection : IIssueProjectionSpecification<jiraissue>
    {
        ...
        public IssueVotesProjection()
        {
            HandleTarget = new FieldKey[]
            {
                IssueFieldSelection.Votes
            };
        ...
        {
            jiraIssue.Votes = entity.VOTES;
            return Task.CompletedTask;
        }
    }

    public class IssueVotesSpecification : QuerySpecification<jiraissue>
    {
        public IssueVotesSpecification(Expression<Func<decimal?, bool>> predicate)
        {
            CriteriaGetter = () => Task.FromResult(QuerySpecificationExtension.Predict((jiraissue issue) => issue.VOTES, predicate));
        }
    }
}
